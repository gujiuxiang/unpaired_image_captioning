...
class FCModel_NMT(CaptionModel):
    def __init__(self, opt):
        super(FCModel_NMT, self).__init__()
    ...
    def _forward(self, fc_feats, att_feats, seq, att_masks=None):
        ...
        # outputs = []
        outputs = Variable(fc_feats.data.new(batch_size, seq.size(1), self.vocab_size + 1).zero_())
        ...
        for i in range(seq.size(1)):
            ...
            outputs[:, i] = F.log_softmax(self.logit(output))
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, opt={}):
        ...
        # seq = []
        # seqLogprobs = []
        seq = Variable(fc_feats.data.new(batch_size, self.seq_length+1).long().zero_())
        seqLogprobs = Variable(fc_feats.data.new(batch_size, self.seq_length+1).zero_())
